...
import { addCourseLecture } from "../../Redux/slices/courseSlice";
...
const AddLecture = () => {
  ...
  return (
    <Layout>
      <div className=" flex flex-col items-center justify-center gap-10 mx-16 my-6">
        <div className="flex flex-col gap-5 p-2 border-2 border-black w-96 rounded-lg">
          <header className="flex items-center justify-center relative">
            ...
            <h1 className="text-xl text-purple-500 font-semibold">
          ...
          <form onSubmit={handleFormSubmit} className="flex flex-col gap-3">
            ...
            <button className="bg-purple-500 text-white py-1 font-semibold text-lg">
              Add Lecture
            </button>
          </form>
        </div>
