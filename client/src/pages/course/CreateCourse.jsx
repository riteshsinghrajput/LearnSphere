...
const CreateCourse = () => {
  ...
  const handleFormSubmit = async (event) => {
    ...
    if (initialCourseData.newCourse) {
      ...
      if (userInput.category === "none") {
        toast.error("Select the course category");
        return;
      }
      // calling the api
    ...
    <Layout>
      <div className="flex items-center justify-center m-4">
        ...
        >
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  name="price"
                  id="price"
                  placeholder="Enter the price in ruppes"
                  className="bg-transparent px-2 py-1 border"
              ...
              <div className="flex flex-col gap-1">
                ...
                <select
                  ...
                  onChange={handleUserInput}
                >
                  <option value="none">Select course category</option>
          ...
          <button
            className="w-full bg-purple-600 hover:bg-purple-500 transition-all ease-in-out duration-300 rounded-sm py-2 font-semibold text-lg cursor-pointer"
            type="submit"
          >
