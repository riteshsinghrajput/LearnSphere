    ...
    <Layout>
      <div className="flex items-center justify-center my-8">
        ...
        >
          ...
          <button
            className="w-full bg-purple-600 text-white hover:bg-purple-500 transition-all ease-in-out duration-300 rounded-sm py-2 font-semibold text-lg cursor-pointer"
            type="submit"
          >
            Update Profile
          </button>
